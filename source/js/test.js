...
const results =
[
	new Result("<div>от 0 до 5 баллов – у вас пока нет уровня, но все в ваших руках! Вам нужно начинать с самого начала – Starter или Elementary. Чтобы определиться, ознакомьтесь с их программой <a href='/anglofan.html#programmStarter'>здесь</a>. Уровень можно поменять в течение первых 14 дней обучения.</div>", 0),
	new Result("от 6 до 22 баллов - вы находитесь внутри уровня Elementary Для обучения именно он вам и подходит. Ознакомиться с его программой можно <a href='/anglofan.html#programmStarter'>здесь</a>. Уровень можно поменять в течение первых 14 дней обучения.", 6),
  new Result("от 23 до 53 баллов - вы находитесь внутри уровня Pre-Intermediate Для обучения именно он вам и подходит. Ознакомиться с его программой можно <a href='/anglofan.html#programmStarter'>здесь</a>. Уровень можно поменять в течение первых 14 дней обучения.", 23),
  new Result("от 54 до 70 баллов – у вас уровень Pre-Intermediate Для обучения вам подойдет следующий уровень - Intermediate. Ознакомиться с его программой можно <a href='/anglofan.html#programmStarter'>здесь</a>. Уровень можно поменять в течение первых 14 дней обучения.", 54),
  new Result("70-77 баллов – у вас уровень Intermediate. Для обучения вам подойдет следующая ступень - уровень Upper-Intermediate.", 71)
];
